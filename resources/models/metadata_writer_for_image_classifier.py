...
_MODEL_INFO = {
    ...
    "efficientnet-edgetpu-L_quant.tflite":
        ModelSpecificInfo(
            name="EfficientNet-EdgeTpu (L) image classifier",
            version="v1",
            image_width=300,
            image_height=300,
            image_min=0,
    ...
    "efficientnet-edgetpu-M_quant.tflite":
        ModelSpecificInfo(
            name="EfficientNet-EdgeTpu (M) image classifier",
            version="v1",
            image_width=240,
            image_height=240,
            image_min=0,
    ...
    "efficientnet-edgetpu-S_quant.tflite":
        ModelSpecificInfo(
            name="EfficientNet-EdgeTpu (S) image classifier",
            version="v1",
            image_width=224,
            image_height=224,
            image_min=0,
    ...
    "inception_v1_224_quant.tflite":
        ModelSpecificInfo(
            name="Inception V1 image classifier",
            version="v1",
            image_width=224,
            image_height=224,
            image_min=0,
    ...
    "inception_v2_224_quant.tflite":
        ModelSpecificInfo(
            name="Inception V2 image classifier",
            version="v2",
            image_width=224,
            image_height=224,
            image_min=0,
