...
public class ILPTask {
    ...
    public ILPTask(GRBModel model) {

        this.grb_model = model;
        try {
            this.start_time = this.grb_model.addVar(0.0, GRB.INFINITY, 0.0, GRB.CONTINUOUS, "");
            this.finish_time = this.grb_model.addVar(0.0, GRB.INFINITY, 0.0, GRB.CONTINUOUS, "");
            this.total_comm_cost =
                    this.grb_model.addVar(0.0, GRB.INFINITY, 0.0, GRB.CONTINUOUS, "");
            this.total_execution_cost =
                    this.grb_model.addVar(0.0, GRB.INFINITY, 0.0, GRB.CONTINUOUS, "");
            this.total_sending_comm_cost =
                    this.grb_model.addVar(0.0, GRB.INFINITY, 0.0, GRB.CONTINUOUS, "");
            this.total_receiving_comm_cost =
                    this.grb_model.addVar(0.0, GRB.INFINITY, 0.0, GRB.CONTINUOUS, "");
