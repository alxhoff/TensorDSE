...
def distributed_inference(tflite_model_path:str, input_data:np.array, output_data:np.array, input_data_size:int, output_data_size:int, hardware_target:str, benchmarking_count: int):
