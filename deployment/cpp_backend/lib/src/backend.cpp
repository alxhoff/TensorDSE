...
int distributed_inference_cpu(std::string tflite_model_path, uint8_t* input_data, 
                                                             uint8_t* output_data, 
    ...
    std::vector<uint8_t> data(input_data, input_data + input_data_size);
    ...
    std::vector<uint8_t> final_data = GetTensorData(*interpreter->output_tensor(0));
...
int distributed_inference_gpu(std::string tflite_model_path, uint8_t* input_data, 
                                                             uint8_t* output_data, 
                                                             const unsigned int input_data_size, 
                                                             const unsigned int output_data_size,
                                                             const unsigned int benchmarking_count) {
...
int distributed_inference_tpu(std::string tflite_model_path, uint8_t* input_data, 
                                                             uint8_t* output_data, 
                                                             const unsigned int input_data_size, 
                                                             const unsigned int output_data_size,
                                                             const unsigned int benchmarking_count) {
