...
run_full_flow() {
    ...
    python3 profiler.py -u $USBMON -m resources/models/example_models/MNIST_full_quanitization.tflite -c 10
    ls /home/sources/TensorDSE/resources
    ls /home/sources/TensorDSE/resources/profiling_results
