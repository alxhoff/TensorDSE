...
#else
#  define _cffi_f_distributed_inference_interface _cffi_d_distributed_inference_interface
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "distributed_inference_interface", (void *)_cffi_f_distributed_inference_interface, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_distributed_inference_interface },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_cpp_interface(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_cpp_interface(void) { return NULL; }
#  else
     initcpp_interface(void) { }
#  endif
#  endif
...
{
  return _cffi_init("cpp_interface", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initcpp_interface(void)
{
  _cffi_init("cpp_interface", 0x2601, &_cffi_type_context);
}
#endif
